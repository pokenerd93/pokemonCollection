...
def basePromoCards():
    ...
    table.heading('Market', text='Market')
    ...
    for cards in cardsData['data']:
        ...
        try:
            market_price_standard = cards['tcgplayer']['prices']['normal']['low']
            format_number_standard = "${:,.2f}".format(market_price_standard)
        except KeyError:
            try:
                market_price_standard = cards['tcgplayer']['prices']['holofoil']['low']
                format_number_standard = "${:,.2f}".format(market_price_standard)
            except KeyError:
...
def baseCards():
    ...
    table = ttk.Treeview(baseSetWindow,
                         columns=('Card No', 'Name', 'Type', 'Rarity', 'Unlimited Market'),
                         show='headings')
    table.heading('Card No', text='Card No')
    table.heading('Name', text='Name')
    table.heading('Type', text='Type')
    table.heading('Rarity', text='Rarity')
    table.heading('Unlimited Market', text='Unlimited Market')
    table.pack(fill='both', expand=True)
...
def baseJungleCards():
    ...
    table = ttk.Treeview(baseJungleSetWindow,
                         columns=('Card No', 'Name', 'Type', 'Rarity', 'Unlimited Market', '1st Edition Market'),
                         show='headings')
    table.heading('Card No', text='Card No')
    table.heading('Name', text='Name')
    table.heading('Type', text='Type')
    table.heading('Rarity', text='Rarity')
    table.heading('Unlimited Market', text='Unlimited Market')
    table.heading('1st Edition Market', text='1st Edition Market')
    table.pack(fill='both', expand=True)
    ...
    for cards in cardsData['data']:
        ...
        # Standard Market Column
        try:
            market_price_standard = cards['tcgplayer']['prices']['unlimited']['low']
            format_number_standard = "${:,.2f}".format(market_price_standard)
        except KeyError:
            try:
                market_price_standard = cards['tcgplayer']['prices']['unlimitedHolofoil']['low']
                format_number_standard = "${:,.2f}".format(market_price_standard)
            except KeyError:
                format_number_standard = "-"

        # 1st Edition Market Column
        try:
            market_price_1st = cards['tcgplayer']['prices']['1stEdition']['low']
            format_number_1st = "${:,.2f}".format(market_price_1st)
        except KeyError:
            try:
                market_price_1st = cards['tcgplayer']['prices']['1stEditionHolofoil']['low']
                format_number_1st = "${:,.2f}".format(market_price_1st)
            except KeyError:
                format_number_1st = "-"

        data = (card_no, name, card_type, rarity, format_number_standard, format_number_1st)
        table.insert(parent='', index=0, values=data)
...
def neoGenesisCards():
    ...
    neoGenesisSetWindow = Toplevel(pokemonSets)
    neoGenesisSetWindow.title("Neo Genesis")
    neoGenesisSetWindow.geometry("1250x750")

    try:
        r = requests.get(filtered_neo_sets[0]['images']['logo'])
    ...
    label_image = ttk.Label(master=neoGenesisSetWindow)  # <-- place for image
    ...
    # Treeview
    table = ttk.Treeview(neoGenesisSetWindow,
                         columns=('Card No', 'Name', 'Type', 'Rarity', 'Unlimited Market', '1st Edition Market'),
                         show='headings')
    table.heading('Card No', text='Card No')
    table.heading('Name', text='Name')
    ...
    # retrieve series json file of series from GitHub
    cardsJson = requests.get("https://api.pokemontcg.io/v2/cards?orderBy=-number&q=id:neo1")
    cardsLoad = cardsJson.text
    cardsData = json.loads(cardsLoad)
...
def neoDiscoveryCards():

    neoDiscoverySetWindow = Toplevel(pokemonSets)
    neoDiscoverySetWindow.title("Neo Discovery")
    neoDiscoverySetWindow.geometry("1250x750")

    try:
        r = requests.get(filtered_neo_sets[1]['images']['logo'])
    ...
    label_image = ttk.Label(master=neoDiscoverySetWindow)  # <-- place for image
    ...
    # Treeview
    table = ttk.Treeview(neoDiscoverySetWindow,
                         columns=('Card No', 'Name', 'Type', 'Rarity', 'Unlimited Market', '1st Edition Market'),
                         show='headings')
    table.heading('Card No', text='Card No')
    table.heading('Name', text='Name')
    ...
    # retrieve series json file of series from GitHub
    cardsJson = requests.get("https://api.pokemontcg.io/v2/cards?orderBy=-number&q=id:neo2")
    cardsLoad = cardsJson.text
    cardsData = json.loads(cardsLoad)
...
def neoRevelationCards():

    neoRevelationSetWindow = Toplevel(pokemonSets)
    neoRevelationSetWindow.title("Neo Revelation")
    neoRevelationSetWindow.geometry("1250x750")

    try:
        r = requests.get(filtered_neo_sets[2]['images']['logo'])
    ...
    fp = io.BytesIO(r.content) # <-- create file-like object in memory
    image = Image.open(fp) # <-- use file-like object in memory
    new_image = image.resize((175, 100))
    photo = ImageTk.PhotoImage(new_image)

    label_image = ttk.Label(master=neoRevelationSetWindow)  # <-- place for image
    ...
    # Treeview
    table = ttk.Treeview(neoRevelationSetWindow,
                         columns=('Card No', 'Name', 'Type', 'Rarity', 'Unlimited Market', '1st Edition Market'),
                         show='headings')
    table.heading('Card No', text='Card No')
    table.heading('Name', text='Name')
    ...
    # retrieve series json file of series from GitHub
    cardsJson = requests.get("https://api.pokemontcg.io/v2/cards?orderBy=-number&q=id:neo3")
    cardsLoad = cardsJson.text
    cardsData = json.loads(cardsLoad)
...
def neoDestinyCards():
    ...
    neoDestinySetWindow = Toplevel(pokemonSets)
    neoDestinySetWindow.title("Neo Destiny")
    neoDestinySetWindow.geometry("1250x750")

    try:
        r = requests.get(filtered_neo_sets[3]['images']['logo'])
    ...
    label_image = ttk.Label(master=neoDestinySetWindow)  # <-- place for image
    ...
    # Treeview
    table = ttk.Treeview(neoDestinySetWindow,
                         columns=('Card No', 'Name', 'Type', 'Rarity', 'Unlimited Market', '1st Edition Market'),
                         show='headings')
    table.heading('Card No', text='Card No')
    table.heading('Name', text='Name')
    ...
    # retrieve series json file of series from GitHub
    cardsJson = requests.get("https://api.pokemontcg.io/v2/cards?orderBy=-number&q=id:neo4")
    cardsLoad = cardsJson.text
    cardsData = json.loads(cardsLoad)
...
class neoSeries:
    ...
    def neo1Info():
        ...
        neo_button1 = ctk.CTkButton(scrollable_frame, text=name, fg_color="white", text_color="black", image=photo, width=1200, height=50, command=neoGenesisCards)
    ...
    def neo2Info():
        ...
        neo_button2 = ctk.CTkButton(scrollable_frame, text=name, fg_color="white", text_color="black", image=photo, width=1200, height=50, command=neoDiscoveryCards)
    ...
    def neo3Info():
        ...
        neo_button3 = ctk.CTkButton(scrollable_frame, text=name, fg_color="white", text_color="black", image=photo, width=1200, height=50, command=neoRevelationCards)
    ...
    def neo4Info():
        ...
        neo_button4 = ctk.CTkButton(scrollable_frame, text=name, fg_color="white", text_color="black", image=photo, width=1200, height=50, command=neoDestinyCards)
...
def legendaryCards():
    ...
    legendarySetWindow = Toplevel(pokemonSets)
    legendarySetWindow.title("Legendary Collection")
    legendarySetWindow.geometry("1250x750")

    try:
        r = requests.get(filtered_legendary_sets[1]['images']['logo'])
    ...
    fp = io.BytesIO(r.content) # <-- create file-like object in memory
    image = Image.open(fp) # <-- use file-like object in memory
    new_image = image.resize((250, 100))
    photo = ImageTk.PhotoImage(new_image)

    label_image = ttk.Label(master=legendarySetWindow)  # <-- place for image
    ...
    # Treeview
    table = ttk.Treeview(legendarySetWindow,
                         columns=('Card No', 'Name', 'Type', 'Rarity', 'Standard Market', 'Parallel Market'),
                         show='headings')
    table.heading('Card No', text='Card No')
    table.heading('Name', text='Name')
    table.heading('Type', text='Type')
    table.heading('Rarity', text='Rarity')
    table.heading('Standard Market', text='Standard Market')
    table.heading('Parallel Market', text='Parallel Market')
    table.pack(fill='both', expand=True)

    # retrieve series json file of series from GitHub
    cardsJson = requests.get("https://api.pokemontcg.io/v2/cards?orderBy=-number&q=id:base6")
    cardsLoad = cardsJson.text
    cardsData = json.loads(cardsLoad)
    ...
    for cards in cardsData['data']:
        ...
        # Parllel Market Column
        try:
            market_price_1st = cards['tcgplayer']['prices']['reverse']['low']
            format_number_1st = "${:,.2f}".format(market_price_1st)
        except KeyError:
            try:
                market_price_1st = cards['tcgplayer']['prices']['reverseHolofoil']['low']
                format_number_1st = "${:,.2f}".format(market_price_1st)
            except KeyError:
                format_number_1st = "-"
...
class legendarySeries:
    ...
    def legendaryInfo():
        ...
        leg_button1 = ctk.CTkButton(scrollable_frame, text=name, fg_color="white", text_color="black", image=photo, width=1200, height=50, command=legendaryCards)
